...
## Kesimpulan
Berdasarkan pelaksanaan praktikum Modul 13 mengenai Multi Linked List, dapat disimpulkan bahwa struktur data multilevel linked list mampu merepresentasikan hubungan data secara bertingkat melalui relasi parent–child. Implementasi menggunakan bahasa C++ mempermudah pengelolaan data dinamis karena setiap node parent dapat memiliki list anak yang tersusun secara fleksibel. Operasi dasar seperti alokasi node, penyisipan dan penghapusan parent maupun child, pencarian data berdasarkan ID, serta pencetakan struktur list dapat dilakukan melalui pointer tanpa perlu memindahkan elemen lain seperti pada array. Selain itu, penghapusan node parent juga secara otomatis menghapus seluruh list anak di bawahnya sehingga keterhubungan data tetap konsisten. Dengan demikian, penggunaan Multi Linked List terbukti efektif untuk menangani data yang memiliki relasi satu-ke-banyak dan struktur hierarkis dalam pemrograman.
